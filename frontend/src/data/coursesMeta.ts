...
export const COURSE_VISUAL_META: Record<string, CourseVisualMeta> = {
  "coding-creative-logic": {
    ...
    gradientHeader: "from-emerald-600 via-teal-600 to-emerald-800",
  ...
  "web-creator-lab": {
    ...
    gradientHeader: "from-emerald-700 via-amber-600 to-[#0d2922]",
  ...
  "practical-ai-for-students": {
    ...
    gradientHeader: "from-teal-700 via-indigo-700 to-[#0d2922]",
