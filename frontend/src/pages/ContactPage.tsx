  ...
  return (
    <>
      <Seo
        ...
        description="Ask a question about courses, registration, or customized 1:1 learning for your child."
      />
        ...
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[.85fr_1.15fr] lg:items-start">
          <div>
            ...
            <p className="mt-6 text-base leading-8 text-[#597068] sm:text-lg">
              Questions about age, experience, class structure, or course fit are welcome. Tell us a little about your learner and we will reply personally.
            </p>
            ...
            <div className="mt-9 grid gap-4">
              ...
              <div className="rounded-2xl border border-emerald-100 bg-emerald-50/60 p-5">
                ...
                <Button asChild size="sm" className="mt-3">
                  <Link to="/trial">Book free 45-min trial <ArrowRight className="ml-1.5 h-3.5 w-3.5" /></Link>
                </Button>
              </div>
            </div>
          </div>
            ...
            {state === "sent" ? (
              ...
              <>
                ...
                <div className="mt-6 grid gap-5 sm:grid-cols-2">
                  ...
                  <label className="grid gap-2 text-sm font-bold">
                    Subject
                    <Input required name="subject" placeholder="Course question or learner inquiry" />
                  </label>
