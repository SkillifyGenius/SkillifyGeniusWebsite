...
export function BlogPage() {
  ...
  // Keyboard escape listener to close reader modal
  useEffect(() => {
      ...
      {activePost && (
        ...
        >
          ...
          >
            ...
            {/* Article Content */}
            <div className="mt-8">
              <h1 className="font-display text-3xl font-black leading-tight text-[#102a25] sm:text-4xl">
                {activePost.title}
              </h1>
            ...
            <div className="mt-12 rounded-3xl border border-emerald-700/20 bg-emerald-50/70 p-6 sm:p-8">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <Button asChild size="lg" className="shrink-0">
                  <Link to="/trial" onClick={() => setActivePost(null)}>
