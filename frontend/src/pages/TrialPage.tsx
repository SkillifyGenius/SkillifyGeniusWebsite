            ...
            {state === "sent" ? (
              <div className="grid min-h-[650px] place-items-center text-center">
                <div className="max-w-lg">
                  ...
                  <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
                    ...
                    <Button asChild><Link to="/courses">Explore courses <ArrowRight className="ml-2 h-4 w-4" /></Link></Button>
                  </div>
                </div>
              </div>
            ) : (
              <form onSubmit={submit}>
                ...
                <p className="mt-4 text-center text-xs leading-5 text-muted-foreground">
                  ...
                  <Link to="/privacy" className="font-bold text-primary underline">privacy notice</Link>.
                </p>
              </form>
            )}
          </div>
